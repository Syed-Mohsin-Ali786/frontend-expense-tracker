  ...
  return (
    <div className=" mt-4 mx-4 p-4">
      ...
      <header className="flex items-center justify-between">
        ...
        <button className="cursor-pointer border border-blue-400 py-2 px-3 md:px-6 lg:px-8 rounded font-semibold text-blue-500 text-2xl hover:bg-blue-600 hover:text-[#fff]">
          Log out
        </button>
      </header>
