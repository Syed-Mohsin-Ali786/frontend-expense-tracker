  ...
  return (
    <div className=" mt-4 mx-4 p-4">
      ...
      <header className="flex items-center justify-between">
        ...
        <button className="cursor-pointer border border-blue-500 py-2 px-3 md:px-6 lg:px-8 rounded font-semibold text-blue-500 text-2xl hover:bg-blue-600 hover:text-[#fff]">
          Log out
        </button>
      </header>
      ...
      <section className="mt-6 shadow border-gray-200 border px-4">
        ...
        <div className="flex flex-col w-[50vw] justify-between mt-4 ">
          <div className="flex justify-between items-center ">
            ...
            <button className="cursor-pointer hover:bg-blue-700 bg-blue-600  py-2 px-3 md:px-6 lg:px-8 rounded-[12px] font-semibold text-[#ffff] text-2xl">
              Add Expense
            </button>
          </div>
          <div>
