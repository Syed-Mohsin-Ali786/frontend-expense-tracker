...
<div className='flex'>
<h1 className='text-4xl  font-semibold'>Expense Tracker</h1>
     <button className='flex items-center justify-center bg-blue-600 border border-blue-500 py-1 px-3 md:px-6 lg:px-8 rounded font-semibold text-[#ffff] text-2xl '>Add Expense</button>
