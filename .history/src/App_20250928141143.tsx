...
function App() {
  return (
    <div className=" mt-4 mx-4 p-4">
      ...
      <section>
        {/* Expenses */}
        <div className="flex flex-col w-[50vw] justify-between p-2">
          ...
          <input type="text" placeholder="Search"  className="py-2 px-4 text-2xl border-gray-300 border rounded mt-4 mx-6"/>
        </div>
        {/* Charts */}
        <div></div>
      </section>
