        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-4">
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              value={form.category}
              onChange={handleChange}
              className="rounded-lg border dark:bg-input/30 bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] shadow border-gray-300 focus:ring-blue-400 py-2 px-3"
              required
            >
